...
#%matplotlib inline
df = pd.read_csv("../Projectcode/breast-cancer.csv", index_col=0)
df.head()
df.info()
...
fob = open("model_fit","wb")
pickle.dump(logistic_fit, fob)

print(logistic_fit.summary())
# predict the test data and show the first 5 
print("Various",X_test.columns)
fob2 = open("Xtest","wb")
pickle.dump(X_test, fob2)
print(X_test , "XXXXXXXXXXXXXXXXXXXXXXXXXx")
